...
function flatsome_maintenance_mode()
{
  ...
  wp_die( '<center><img src="'.$flatsome_opt['site_logo'].'"/ style="max-width:200px;"><h2>' . __( 'Em Manutenção', 'flatsome-maintenance-mode' ) . '</h2><p>' . $flatsome_opt['maintenance_mode_text'] . '</p></center>', __( 'Em Manutenção', 'flatsome-maintenance-mode' ), array('response' => '503'));
  }
}
